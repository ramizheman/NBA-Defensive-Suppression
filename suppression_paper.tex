...
\textbf{Code.} Replication code, frozen trigger tables, and figure sources are at \url{https://github.com/ramizheman/NBA-Defensive-Suppression}. Ingestion and classification code used to build those tables is available from the author on request.
